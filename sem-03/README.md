# Обектно-ориентираното програмиране. Член-функции. Конструктор и деструктор. Абстракция и капсулация. 
...
### **Принципи:**
- **Абстракция** - процесът на скриване на ненужни подробности от потребителя
- **Капсулация** - един обект трябва да предоставя на ползващия го само пряко необходимите му средства за управление.
- **Наследяване** - позволява да бъдат дефинирани и създавани обекти, които са специализирани варианти на вече съществуващи обекти. Kласът наследник взема всички свойства и методи на класа-родител
