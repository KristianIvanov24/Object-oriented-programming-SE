...
class B : public A
{
	int z;
public:
	B() : z(0) /* def A() */ {std::cout << "B()" << std::endl;}
	B(int z) : z(z), A(0,0) {std::cout << "B(z)" << std::endl;}
	B(int x, int y, int z) : z(z), A(x,y) {std::cout << "B(x,y,z)" << std::endl;}
	
	void print() const {A::print(); std::cout << ' ' << z << std::endl;}
