...
зависимост от обектите, върху които се прилагат. <br> <br>

Полиморфизмът бива: 
- Compile-time polymorphism (статичен полиморфизъм)
- Run-time polymorphism (динамичен полиморфизъм)
...
## Ключови думи virtual, override и final
- ```virtual``` указва, че функцията може да бъде предефинирана в наследник и извиквана полиморфно.
...
![image](https://drive.google.com/uc?export=view&id=1vZFzNN6poIP_gdnns_60hSBwdIz3ImaE)
