## Задача 0 Live Coding

Реализирайте клас Repository<T>, който представлява generic хранилище за обекти от тип T.

Реализирайте следните функционалности:
- `add` - добавяне на елемент (по копие и по move)
- `addAll` - добавяне на множество елементи наведнъж
- `getAll` - връща всички елементи
- `size` - брой елементи
- `isEmpty` - проверка дали хранилището е празно
- `contains` - проверка дали съществува елемент, отговарящ на критерий
- `findWhere` - връща първия елемент, отговарящ на критерий
- `findAllWhere` - връща всички елементи, отговарящи на критерий
- `update` - замяна на елемент по индекс
- `updateWhere` - обновяване на всички елементи, отговарящи на критерий
- `remove` - премахване на елемент по индекс
- `removeWhere` - премахване на всички елементи, отговарящи на критерий
- `clear` - изчистване на хранилището

Реализирайте наследници на Repository<T> по ваш избора например ProductRepository, StudentRepository etc. 
